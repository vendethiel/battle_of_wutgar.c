...
int info_stat(t_char* character, t_enemy* enemy) {
  ...
  printf("Data : You're called %s, you're a %s. "
         "You got " COLOR_RED "%i" COLOR_CLEAR "/" COLOR_RED "%i" COLOR_CLEAR
         " HP and " COLOR_BLUE "%i" COLOR_CLEAR "/" COLOR_BLUE "%i" COLOR_CLEAR
         " mana.\n",
         character->name, character->class->name, character->hp,
         character->class->hp_pool, character->mp, character->class->mp_pool);
...
int info_libra(t_char* character, t_enemy* enemy) {
  ...
  --character->mp;
  printf("Enemy data : enemy's name is %s, with " COLOR_RED "%i" COLOR_CLEAR
         " HP and " COLOR_BLUE "%i" COLOR_CLEAR " mana",
...
deals " CR "7" CC " dmg.\n- slash : does " CR "10" CC
         " damage, hurts you for " CR "2\
" CC ". If you're a warrior, you have 10%% chance to double your dmg and not get\
 hurt.\n- fire : costs " CB "2" CC " mana, does " CR "10" CC
         " dmg.\n- thunder : does \
" CR "15" CC " dmg, " CB "5" CC
         " mp. If you're a mage, 10%% chance that you stun the \
enemy.\nItems :\n- Potion : heals you for " CG "30" CC
         "HP. Be careful, you might \
break it. You have 5 of these when you start your quest.\n- Ether : gives you \
" CB "12" CC " mana back.\nDefensive spells :\n- heal : heals you for " CG
         "25%%\
" CC " of your base mana. costs " CB "3" CC
         " mp.\n- roar : motivates your chimaeras\
, giving them power/mana ... Maybe ;). Costs " CB "10" CC " mana.\nSpecials :\n\
- execute (warrior) : deals " CR "25" CC " dmg to your enemy, " CR "8" CC
         " to you\n\
- meteor (mage) : costs " CB "10" CC " mana, deals " CR "25" CC " dmg.\n\
- stealfist (thief) : deals " CR "15" CC " damage and steals " CB "4" CC
         " mana\n\
